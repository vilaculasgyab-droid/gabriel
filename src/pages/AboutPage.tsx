...
export const AboutPage: React.FC<AboutPageProps> = ({ onNavigate, onOpenQuoteModal }) => {
  useSEO({
    title: 'Sobre a Z FORÇA E PROTEÇÃO | Segurança em Primeiro Lugar',
    description: 'Conheça a Z FORÇA E PROTEÇÃO, distribuidora de fardamento de segurança, acessórios táticos, botas, equipamento antimotim e produtos eletrónicos em Moçambique.',
        ...
        <div className="relative rounded-3xl bg-slate-900 text-white p-8 sm:p-12 overflow-hidden shadow-xl border border-slate-800 mb-12">
          ...
          <div className="relative z-10 max-w-3xl">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-amber-400 bg-amber-400/10 border border-amber-400/20 px-3.5 py-1.5 rounded-full mb-4">
              ...
              <span>Conheça a Z FORÇA E PROTEÇÃO</span>
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight mb-4">
              Segurança em Primeiro Lugar • Moçambique
            </h1>
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed mb-6">
              A <strong>Z FORÇA E PROTEÇÃO</strong> é líder e referência no fornecimento de fardamento operacional, acessórios táticos, calçado de intervenção, equipamentos antimotim e sistemas eletrónicos de proteção para empresas e forças de segurança em Moçambique.
            </p>
