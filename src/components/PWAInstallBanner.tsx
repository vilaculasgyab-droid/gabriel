        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex flex-col text-left">
              ...
              <p className="text-xs sm:text-sm font-medium text-slate-200 line-clamp-1 sm:line-clamp-none">
                <strong>Tenha a Z FORÇA E PROTEÇÃO sempre consigo.</strong> Instale a nossa loja no seu telemóvel para acesso rápido.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto flex-shrink-0">
            ...
            >
              ...
              <span>{installing ? 'A instalar...' : 'Instalar Z FORÇA'}</span>
            </button>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-bold text-white">Instalar Z FORÇA no iPhone / iPad</h3>
