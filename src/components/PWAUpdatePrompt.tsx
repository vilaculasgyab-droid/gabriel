...
export const PWAUpdatePrompt: React.FC = () => {
  const {
    ...
    onRegistered(r) {
      if (r) {
        console.log('Service Worker registered successfully for Z FORÇA E PROTEÇÃO PWA');
      }
    },
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-slate-200 mt-1 leading-snug">
            Uma nova versão da Z FORÇA E PROTEÇÃO com novidades no catálogo está disponível.
          </p>
