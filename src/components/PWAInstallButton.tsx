  ...
  const renderButton = () => {
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div className="text-left">
              <div className="text-white text-xs font-bold">Instalar Z FORÇA</div>
    ...
    return (
      <button
        onClick={handleClick}
        disabled={installing}
        title="Instalar loja Z FORÇA E PROTEÇÃO no seu dispositivo"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-bold text-white">Instalar Z FORÇA no iOS</h3>
